...
$(window).on('scroll', function () {
	...
	if (scroll < 100) {
		$("#header-sticky").removeClass("sticky-manu");
	} else {
		$("#header-sticky").addClass("sticky-manu");
	}
});
...
// offCanvars-cart-code 
$(".manu-bar").on("click", function(){
	$(".off-canvar-cart-bar, .offCanvas-overly").addClass("active");
	return false;
})

$(".offCanvas-overly, .cart-closs").on("click", function(){
	$(".off-canvar-cart-bar, .offCanvas-overly").removeClass("active");
	return false;
})
